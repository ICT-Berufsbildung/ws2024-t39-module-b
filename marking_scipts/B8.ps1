...
foreach ($scope in $scopes) {
    ...
    if ($leaseStart -eq "10.40.0.100" -and $leaseEnd -eq "10.40.0.200") {
    ...
    $expectedExclusions = @("10.40.0.100", "10.40.0.150")
