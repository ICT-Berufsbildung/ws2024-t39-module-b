...
New-Item -Path 'C:\Program Files\WSC2024' -ItemType Directory | Out-Null
...
Invoke-WebRequest -Uri $Env:PACKER_HTTP_ADDR/marking.zip -OutFile "C:\Program Files\WSC2024\marking.zip"